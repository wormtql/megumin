...
namespace megumin {
    ...
    void SimpleInstructionMutation::visit_dp_imm_add_sub(const arm::Instruction &instruction) {
        result = mutate_dp_imm_add_sub.mutate(*program, position);
    }
